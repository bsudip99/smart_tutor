                                                    ...
                                                    <ul id="users">
                                                        @foreach ($users as $user)
                                                            <a href="javascript:void(0);" class="chat-toggle"
                                                                ...
                                                                data-user="{{ $user->name }}">
                                                                <li
                                                                    style="background:grey; height:40px; width:100%; align:center;">
                                                                    <button class="btn btn-lg btn-info" style="width:100%;">  <span
                                                                        class="label label-info"> {{ $user->name }}</span> </button>
